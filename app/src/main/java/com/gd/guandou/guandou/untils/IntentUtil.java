...
public class IntentUtil {
     ...
     * @param clzz
     */
    public static void goIntent(Activity context, Class<?> clzz,Bundle bundle ,Boolean isfinish) {
     ...
     * @param clzz
     */
    public static void goResultIntent(Activity context, Class<?> clzz,Bundle bundle ,Boolean isfinish,int requestCode) {
        Intent intent = new Intent(context, clzz);
        if (bundle!=null){
            intent.putExtras(bundle);
        }
...
//        intent.setAction(Intent.ACTION_GET_CONTENT);
    ...
    public static void takePhoto(Activity context, int requestCode, Uri cameraUri) {
        ...
        if (SDState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            L.i(TAG, "cameraUri.path------>" + cameraUri.getPath());
     ...
     * @param uri
     */
    public static Uri takePhoto(Activity context, Uri uri, int requestCode) {
...
//            imageView.setImageURI(Uri.parse(picPath));
     ...
     * @param requestCode
     */
    public static void cropImage(Activity context, Uri uri, int outputX, int outputY, int requestCode,String filePath) {
        // 裁剪图片意图
...
//        {
//            imageUri = FileProvider.getUriForFile(context,"com.studio.cameraalbumtest.fileprovider",new File(filePath));
//        }
//        else
//        {
...
//        intent.putExtra("outputFormat", Bitmap.CompressFormat.JPEG);
        Log.e("cropImage",Uri.fromFile(new File(filePath)).toString());
        context.startActivityForResult(intent, requestCode);
    }
