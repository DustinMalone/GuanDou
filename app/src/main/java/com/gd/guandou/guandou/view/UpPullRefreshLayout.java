...
import com.gd.guandou.guandou.R;
     ...
     *
     * @author mrsimple
     */public class UpPullRefreshLayout extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
        ...
        public UpPullRefreshLayout(Context context, AttributeSet attrs) {
            ...
            mTouchSlop = ViewConfiguration.get(context).getScaledDoubleTapSlop()+50;
